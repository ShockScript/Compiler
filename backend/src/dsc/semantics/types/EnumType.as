package dsc.semantics.types {
    ...
    public final class EnumType extends Type {
        ...
        override public function defineEnumSpecialMethods(lexicalPublicNs:Symbol):void {
            ...
            var setMethod:Symbol = ctx.factory.methodSlot(ctx.factory.name(lexicalPublicNs, 'set'), ctx.factory.methodSignature([this], null, false, this));
            setMethod.methodFlags |= MethodFlags.NATIVE;
            this.delegate.names.defineName(setMethod.name, setMethod);
            _specialMethods.setMethod = setMethod;
